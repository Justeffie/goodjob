<header>
  ...
  <div class="head">
    ...
    <label for="act">
      <img class="perfil" src="<?php/* echo $nombreDeProfile; */?>" alt="">
    </label>
    ...
    <div class="barra-contenedor">
      <ul class="barralat">
        <li><div class="perfil-container"><img class="perfil-barralat" src="<?php echo $nombreDeProfile; ?>" alt=""></div><p id="user"><?php/* echo $nombreDeUsuario */?></p></li>
